...
const Dates = ({ text1, text2, customStyles }) => {
  ...
  return (
    <>
      <div className={`flex flex-row w-full xl:w-[300px] border border-solid border-gray-600 rounded-xl h-[50px] items-center px-5 cursor-pointer mb-4 xl:mb-0 ${customStyles}`}>
