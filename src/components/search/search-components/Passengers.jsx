  ...
  return (
    <>
      <div className="relative">
        <div
          className="flex flex-row w-[300px] border border-solid border-gray-600 rounded-xl h-[50px] items-center px-5 cursor-pointer"
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[16px] text-gray-700">
              ...
              {passengerCounts.adults !== 1 && "s"}, {passengerCounts.children}{" "}
              Child{passengerCounts.children !== 1 && "ren"},{" "}
        ...
        {showPassengers && (
          <div className="absolute mt-2 w-full lg:w-[300px] bg-white shadow-lg rounded-lg z-20 top-14">
            <div className="p-4">
